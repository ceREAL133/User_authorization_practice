...
function routes(app) {
    ...
    // register user
    app.post('/api/users', [middleware_1.requiresUser, (0, middleware_1.validateRequest)(user_schema_1.createUserSchema)], user_controller_1.createUserHandler);
    // get users list
    app.get('/api/users', middleware_1.requiresUser, user_controller_1.getAllUsersHandler);
    // get user by id
    app.get('/api/users/:userId', [middleware_1.requiresUser, middleware_1.checkId], user_controller_1.getUserByIdHandler);
    // delete user (by id)
